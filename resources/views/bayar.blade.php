    ...
    <div class="row">
        ...
        <div class="col-12 mb-0" style="background-color: #849573; display: flex; align-items: center; padding: 20px;">
            ...
            <div style="flex: 5; margin-left: 10px; display: flex; justify-content: space-between; align-items: center;">
                <h5 class="text-black m-0" style="font-weight: bold;"> product-name </h5>
                <div style="margin-right: 2px;">
                    <h5 class="text-white m-0" id="product-price" style="font-weight: bold;">Rp product-price </h5>
                </div>
        ...
        <div class="col-12" style="background-color: #849573; padding: 20px; display: flex; justify-content: space-between; align-items: center; border-radius: 0 0 10px 10px;">
            <h4 class="text-white" id="total-price" style="font-weight: bold;">Total: Rp total-price</h4>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (productData) {
            document.querySelector('img').src = productData.image;
            document.querySelector('#product-quantity').innerText = productData.quantity;
            document.querySelector('#product-price').innerText = 'Rp ' + productData.pricePerUnit.toLocaleString();
            document.querySelector('#total-price').innerText = 'Total: Rp ' + productData.totalPrice.toLocaleString();
        }
    });
</script>
