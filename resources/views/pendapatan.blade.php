...
<head>
    ...
    <title>Atma Petshop Pendapatan</title>
...
<body>
    ...
    <div class="main-content" id="mainContent">
        ...
        <div class="table-container">
            <div class="table-title">Detail Pendapatan</div>
                <div class="search-box">
                <img src="{{ asset('images/sort.png') }}" alt="Sort Icon" style="width: 20px; height: 20px; margin-right: 5px; margin-left: 5px;"> 
                <input type="text" placeholder="Cari bulan..." style="max-width: 400px; padding: 5px;"> 
